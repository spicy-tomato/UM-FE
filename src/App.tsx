  ...
  createBrowserRouter([
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'event',
          element: role === 'Student' ? <Event /> : <Navigate to={'/event'} />,
        },
        {
          path: 'student',
          element:
        ...
        },
        {
          path: 'professor',
          element:
            role === 'Student' ? <Professor /> : <Navigate to={'/professor'} />,
        },
        {
          path: 'course',
          element:
...
function App() {
  ...
  const [router, setRouter] = useState<Router>(getRouter(''));
